...
void aom_hadamard_8x8_dual_neon(const int16_t *src_diff, ptrdiff_t src_stride, int16_t *coeff);
...
#define aom_sad_skip_64x16 aom_sad_skip_64x16_neon
...
#define aom_sad_skip_64x16x4d aom_sad_skip_64x16x4d_neon
